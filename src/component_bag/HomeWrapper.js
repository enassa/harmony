...
import  "../css/pagewrapperalternate.css"
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import {FlashOn,SupervisedUserCircle,MonetizationOn,Apps,CancelSharp, CloseSharp, Menu, Notifications, Dashboard, ExpandLess, ExpandMore, Contacts, AccountBalanceWallet, Update, Settings, Kitchen, FlashAuto, Search } from '@material-ui/icons';
import Profile from "../resources/images/MyPic.png";
import CoverPic from "../resources/images/Hacklab.jpg";
import logo from "../resources/images/logo.png";
import Sidebar from './Sidebar';
import InfoCard from './InfoCard';
import Dropdown from './Dropdown';
import ChatRoom from './Chartroom';
          ...
          <div id={"home-content-region"} className={null}>
              ...
              <div id={"home-nav-bar-wrapper"} className={null}>
                <div id={"home-nav-bar-container"}>
                  ...
                  <div id={"navbar-main-container"}>
                    <div id={"navbar-left-region"} className={"nav-bar-regions"}>
            ...
            <div id={"home-popup-region"} >
              <div id={"home-popup-wrapper"}>
                  <div id={"home-popup-container"} className={showPopUp?"popup-visible":null}>
                      ...
                      <div id={"home-pop-up-div"} onClick={()=>{this.props.history.push(ALL_URLS.base)}}>
            ...
            <div id={"home-content-workspace-main"} className={null}>
              <div id={"workspace-wrapper"} className={null}>
                <div id={"member-home-content-workspace-left"} className={null}>
                    {this.props.children}
                </div>
