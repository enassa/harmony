...
class StaticsCard extends Component {
    ...
    processAnswers = () => {
        ...
        function getOccurrence(array, value) {
            ...
            try{
                count = 0;
                array.forEach((v) => (v.toLowerCase() === value.toLowerCase()  && count++));
            }
            catch{}
            return count;
    ...
    render() {
        ...
        if(cardData.responses === undefined) {
            return (
                ...
                className={`curved-corners ${innerWidth<900?innerWidth<600?'height-auto width-90-cent a-center':'height-auto overflow-hidden  width-95-cent a-center':'height-500 min-height-400 width-80-cent '} nate-white-bg  f-column j-start cursor-pointer padding-20 position-relative top-0 margin-b-40  elevated-blend`}
                >
                <div></div>
            ...
            return (
                ...
                className={`curved-corners ${innerWidth<900?innerWidth<600?'height-auto overflow-hidden  padding-top-20 padding-b-20 width-90-cent a-center':'height-auto padding-top-20 padding-b-20  width-90-cent a-center':'height-500 min-height-400 width-80-cent '}  f-column j-start cursor-pointer padding-20 position-relative top-0 margin-b-40  elevated-blend`}
            >
                <div></div>
                <div className='width-100-cent '>{cardData.question}</div>
                <div style={{fontSize:12, color:"#1876D1",fontFamily:fontFamily5}} className='width-100-cent d-flex '>
