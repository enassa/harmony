    ...
    render() {
        ...
        return (
            <div 
                ...
                style={{borderRadius:5, marginBottom:20, backgroundColor:"#DFEFE0"}} className='width-90-cent position-relative padding-20 a-center height-120 min-height-120 elevated-blend'
            >
